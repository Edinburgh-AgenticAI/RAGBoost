...
# Install RAGBoost patches to SGLang

set -e

echo "=============================================="
echo "RAGBoost SGLang Patch Installer"
echo "=============================================="
...
echo "=============================================="
echo ""
echo "To use RAGBoost with SGLang:"
echo ""
echo "  1. Start RAGBoost server:"
echo "     python -m ragboost.server.http_server --port 8765"
echo ""
