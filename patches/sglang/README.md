# SGLang Patches for RAGBoost Integration

This directory contains patched SGLang files required for RAGBoost integration.
...
- Added `create_ragboost_eviction_callback()` function
...
# Start SGLang with RAGBoost integration
