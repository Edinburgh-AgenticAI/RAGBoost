"""
Example: Stateless Batch Scheduling with RAGBoost

This shows how to use RAGBoost in STATELESS mode - just for clustering and 
...
SETUP:
1. Start RAGBoost server in stateless mode:
...
import requests
import json
from ragboost.server.http_client import RAGBoostIndexClient, schedule_batch
...
def example_with_client():
    ...
    print("Scheduling batch with RAGBoost (stateless mode)...")
...
def batch_processing_workflow():
    ...
    This is the typical workflow when using RAGBoost in stateless mode
    ...
    # Step 2: Get optimal scheduling from RAGBoost
    print("\n2. Calling RAGBoost /schedule endpoint...")
...
if __name__ == "__main__":
    ...
    print("RAGBoost Stateless Batch Scheduling Example")
    print("-" * 50)
    print("\nMake sure the server is running in stateless mode:")
    print("  python -m ragboost.server.http_server --port 8765 --stateless")
    print("-" * 50)
    ...
    try:
        ...
        print("  Please start the server first with: python -m ragboost.server.http_server --port 8765 --stateless")
        sys.exit(1)
