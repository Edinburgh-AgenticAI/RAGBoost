"""
RAGBoost Pipeline - Usage Examples

This file demonstrates the most important use cases for the RAGBoost pipeline.
"""

from ragboost.pipeline import RAGPipeline, InferenceConfig

# ============================================================================
# Example 1: Simple RAGBoost Pipeline with BM25 (Retrieve + Optimize)
# ============================================================================

def example_simple_ragboost():
    """Basic RAGBoost usage with BM25: retrieval and optimization only."""
    print("\n" + "="*60)
    print("Example 1: Simple RAGBoost Pipeline (BM25)")
    print("="*60)
    ...
    pipeline.save_results(results, "output_ragboost.jsonl")
...
# ============================================================================
# Example 2: FAISS Retriever with RAGBoost
# ============================================================================

def example_faiss_ragboost():
    """Use FAISS semantic search with RAGBoost optimization."""
    print("\n" + "="*60)
    print("Example 2: FAISS + RAGBoost")
    print("="*60)
...
def example_with_generation():
    ...
    """
    print("\n" + "="*60)
    print("Example 3: RAGBoost + LLM Generation")
    print("="*60)
...
if __name__ == "__main__":
    print("\n")
    print("╔══════════════════════════════════════════════════════════╗")
    print("║         RAGBoost Pipeline Usage Examples                ║")
    print("╚══════════════════════════════════════════════════════════╝")
    
    # Uncomment the examples you want to run:
    
    # example_simple_ragboost()
    # example_faiss_ragboost()
