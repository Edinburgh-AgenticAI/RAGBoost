...
class TestInterContextScheduling:
    ...
    def test_scheduling_includes_all_contexts(self):
        ...
        from ragboost.context_index import build_context_index
        from ragboost.context_ordering import InterContextScheduler
...
class TestGroupScoring:
    ...
    def test_group_score_calculation(self):
        """Test score based on common prefix and group size."""
        from ragboost.context_ordering import InterContextScheduler
        
        scheduler = InterContextScheduler()
        
        # Contexts with common prefix [1, 2, 3]
        contexts = [
            [1, 2, 3, 100],
            [1, 2, 3, 200],
            [1, 2, 3, 300],
        ...
        score = scheduler._calculate_group_score(contexts, [0, 1, 2])
        
        # Score = common_prefix_length * group_size = 3 * 3 = 9
        assert score == 9
    
    def test_no_common_prefix_zero_score(self):
        """Groups with no common prefix should have zero score."""
        from ragboost.context_ordering import InterContextScheduler
    ...
    def test_single_element_group_zero_score(self):
        """Single-element groups should have zero score."""
        from ragboost.context_ordering import InterContextScheduler
        ...
        score = scheduler._calculate_group_score(contexts, [0])
