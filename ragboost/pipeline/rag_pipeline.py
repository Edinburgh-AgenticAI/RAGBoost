...
from ..retriever import BM25Retriever, FAISSRetriever
...
class RAGPipeline:
    ...
    Examples:
        >>> # Simple RAGBoost pipeline (retrieve + optimize)
        ...
        >>> # With LLM generation
        >>> from ragboost.pipeline import InferenceConfig
        >>> pipeline = RAGPipeline(
        ...     retriever="bm25",
        ...     corpus_path="corpus.jsonl",
        ...
        >>> from ragboost.pipeline import RetrieverConfig, OptimizerConfig, InferenceConfig
        >>> pipeline = RAGPipeline(
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            ...
            use_ragboost: Whether to use RAGBoost optimization (shorthand)
    ...
    def optimize(
        ...
        """
        Optimize context ordering using RAGBoost.
        ...
        if not self.optimizer_config.enabled:
            self._log("⚠️  RAGBoost optimization disabled, returning original order")
        ...
        self._log("🔧 Optimizing context ordering with RAGBoost...")
        start_time = time.time()
