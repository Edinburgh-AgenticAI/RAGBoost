# RAGBoost Documentation

Welcome to the RAGBoost documentation. This guide covers everything you need to get started and make the most of RAGBoost.
...
| [Quick Start](getting_started/quickstart.md) | Your first RAGBoost pipeline in 5 minutes |
...
- [GitHub Repository](https://github.com/SecretSettler/RAGBoost)
