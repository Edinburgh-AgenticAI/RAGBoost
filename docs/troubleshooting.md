...
Common issues and solutions for RAGBoost.
...
### "Index not initialized" from RAGBoost server
...
### "ModuleNotFoundError: No module named 'ragboost'"

**Cause:** RAGBoost not installed or wrong environment.
...
# Verify installation
python -c "from ragboost.pipeline import RAGPipeline; print('OK')"
```
...
### RAGBoost server keeps timing out
...
python -m ragboost.server.http_server --port 8766
```
...
1. Check [GitHub Issues](https://github.com/SecretSettler/RAGBoost/issues)
