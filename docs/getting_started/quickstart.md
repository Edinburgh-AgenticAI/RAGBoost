...
Get up and running with RAGBoost in 5 minutes.

## Prerequisites

1. RAGBoost installed ([Installation Guide](installation.md))
...
pipeline = RAGPipeline(
    ...
    use_ragboost=True,  # Enable RAGBoost optimization
...
2. **Optimization**: RAGBoost clustered queries with overlapping documents for maximum prefix sharing
