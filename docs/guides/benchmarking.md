...
This guide explains how to benchmark RAGBoost performance on your machine.
...
```bash
# Make sure RAGBoost is installed
pip install -e .
```

### Slow Performance

1. **Check CPU utilization**: RAGBoost uses multiprocessing for CPU distance computation
